...
insert into documents (count, type_id, product_id, attribute_id) values (10, 1, 1, 1);
insert into documents (count, type_id, product_id, attribute_id) values (20, 1, 1, 2);
insert into documents (count, type_id, product_id, attribute_id) values (15, 1, 1, 3);
insert into documents (count, type_id, product_id, attribute_id) values (-5, 2, 1, 3);
